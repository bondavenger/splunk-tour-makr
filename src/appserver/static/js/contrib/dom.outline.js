...
var DomOutline = function (options) {
    ...
    function isExclude(e) {
        if (self.opts.exclude) {
            ...
            if (jQuery(e.target).parents(self.opts.exclude).length > 0) {
                return true;
            }
        }
    ...
    pub.start = function () {
        ...
        if (self.active !== true) {
            ...
            jQuery('body')
                .on('mousemove.' + self.opts.namespace, updateOutlinePosition)
                .on('keyup.' + self.opts.namespace, stopOnEscape)
                .addClass('outline-dom');
